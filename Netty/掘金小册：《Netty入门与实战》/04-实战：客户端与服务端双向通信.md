...
> 本小节，我们要实现的功能是：客户端连接成功之后，向服务端写一段数据 ，服务端收到数据之后打印，并向客户端回一段数据，文章里面展示的是核心代码，完整代码请参考 [GitHub](https://link.juejin.cn/?target=https%3A%2F%2Fgithub.com%2FlightningMan%2Fflash-netty%2Ftree%2F%E5%AE%A2%E6%88%B7%E7%AB%AF%E4%B8%8E%E6%9C%8D%E5%8A%A1%E7%AB%AF%E5%8F%8C%E5%90%91%E9%80%9A%E4%BF%A1)

## 客户端发数据到服务端

在[客户端启动流程](https://juejin.cn/book/6844733738119593991/section/6844733738274783240)这一小节，我们提到， 客户端相关的数据读写逻辑是通过 `Bootstrap` 的 `handler()` 方法指定
...
在[服务端端启动流程](https://juejin.cn/book/6844733738119593991/section/6844733738270621709)这一小节，我们提到， 服务端相关的数据处理逻辑是通过 `ServerBootstrap` 的 `childHandler()` 方法指定
...
![客户端的输出](./assets/16502aacdb32ba78tplv-t2oaga2asx-zoom-in-crop-mark3024000.webp)

> 客户端

![服务端的输出](./assets/16502aacdb3f0d9ftplv-t2oaga2asx-zoom-in-crop-mark3024000.webp)
...
将这段逻辑添加到客户端之后逻辑处理器 `FirstClientHandler` 之后，客户端就能收到服务端发来的数据，完整的代码参考 [GitHub](https://link.juejin.cn/?target=https%3A%2F%2Fgithub.com%2FlightningMan%2Fflash-netty%2Ftree%2F%E5%AE%A2%E6%88%B7%E7%AB%AF%E4%B8%8E%E6%9C%8D%E5%8A%A1%E7%AB%AF%E5%8F%8C%E5%90%91%E9%80%9A%E4%BF%A1)

客户端与服务端的读写数据的逻辑完成之后，我们先运行服务端，再运行客户端，控制台输出如下

> 服务端

![image.png](./assets/16502aacdb206194tplv-t2oaga2asx-zoom-in-crop-mark3024000.webp)

> 客户端

![image.png](./assets/16502aacdb1f1579tplv-t2oaga2asx-zoom-in-crop-mark3024000.webp)
